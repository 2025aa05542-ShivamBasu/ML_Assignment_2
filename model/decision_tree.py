"""
Decision Tree model for Obesity dataset
...
class DecisionTreeModel:
    """Decision Tree Classifier for Obesity dataset"""
    
    def __init__(self):
        self.model: DecisionTreeClassifier = None

    def train(self, X, y, **kwargs) -> DecisionTreeClassifier:
        """
...
def main(save_path: str = "model/decision_tree_model.joblib"):
    """Train and evaluate Decision Tree on Obesity dataset"""
    ...
    dt.train(X_train, y_train, max_depth=15)
    ...
    extras = {
        ...
        "feature_importance": dt.get_feature_importance(),
    }
    dt.save(save_path, extras=extras)
