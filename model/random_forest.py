"""
Random Forest model for Obesity dataset

Ensemble method - provides training, evaluation, save/load and predict API.
"""
...
class RandomForestModel:
    """Random Forest Classifier (Ensemble) for Obesity dataset"""
    
    def __init__(self):
        self.model: RandomForestClassifier = None

    def train(self, X, y, **kwargs) -> RandomForestClassifier:
        """
...
def main(save_path: str = "model/random_forest_model.joblib"):
    """Train and evaluate Random Forest on Obesity dataset"""
    ...
    rf.train(X_train, y_train, n_estimators=100, max_depth=20)
    ...
    rf.save(save_path, extras=extras)
